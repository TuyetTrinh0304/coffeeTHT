    ...
    return (
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : "height"}>
            <ScrollView style={{ padding: 10 }}>
                <Button textColor="white" buttonColor="#ff555b" style={{ margin: 10 }} mode="contained" onPress={handleUploadImage}>
                    Upload Image
                </Button>
                {imagePath !== "" && (
                    <Image source={{ uri: imagePath }} style={{ height: 200 }} />
                )}
                <Text style={{ fontSize: 20, fontWeight: "bold" }}>Tên món (nước):</Text>
                <TextInput
                    placeholder="Trà sữa, bánh tráng trộn, v.v..."
                    value={title}
                ...
                <Picker
                    ...
                    style={{ marginBottom: 10, borderWidth: 1, borderColor: "#ccc" }}
                >
                    <Picker.Item color="#FF8C00" label="Đồ ăn vặt" value="Đồ ăn vặt" />
                    <Picker.Item color="#FF8C00" label="Đồ uống" value="Đồ uống" />
                </Picker>
                <Button buttonColor="#ff555b" textColor="white" mode="contained" onPress={handleAddNewMenu}>
                    Thêm món ăn
                </Button>
            </ScrollView>
