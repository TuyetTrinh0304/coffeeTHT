    ...
    return (
      ...
      style={{flex:1}} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
            <ScrollView style={{ padding: 10 }}>
                ...
                <Button style={{ margin: 20 }} buttonColor="#ff555b" textColor="white" mode="contained" onPress={handleUploadImage}>
                    Thay đổi hình ảnh
                </Button>
                ...
                />
                <Text style={{ fontSize: 20, fontWeight: 'bold' }}>Thông tin món (nước): </Text>
                <TextInput
                    style={{ marginBottom: 10, borderWidth: 1, borderColor: '#ccc', padding: 5 }}
                    value={infoMenu}
                ...
                />
                <Button buttonColor="#ff555b" textColor="white" mode="contained" onPress={handleUpdateMenu}>
                    Cập nhật
                </Button>
            </ScrollView>
        </KeyboardAvoidingView>
